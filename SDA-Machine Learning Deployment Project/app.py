...
def main():
    # Set Streamlit theme colors and background color
    st.set_page_config(
    ...
    # Allow users to manually enter values
    st.write("### Enter the car details manually:")
    age = st.slider("Age of the car", min_value=1, max_value=20, value=5)
    ...
    # Allow users to choose Gearing Type and Car Model from a list
